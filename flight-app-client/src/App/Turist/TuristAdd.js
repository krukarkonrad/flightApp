...
import { postTurist } from '../../Util/APIUtilsTurist'
...
import './TuristAdd.css'

class TuristAdd extends Component{
    constructor(props) {
        super(props);
        this.state = {
            name: {
    ...
    render(){
        return(
            <div className="turist-add-container">
            <h1 className="page-title">Add new turist</h1>
            <div className="add-content">
                <Form className="add-turist-form">
                    <FormItem
                        label="Name"
